    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PortfolioClients", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PortfolioClientId = table.Column<int>(type: "int", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PortfolioProjects_PortfolioClients_PortfolioClientId",
                        column: x => x.PortfolioClientId,
                        principalTable: "PortfolioClients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateTable(
                name: "DevelopmentTechnologyPortfolioProject",
                columns: table => new
                {
                    DevelopmentTechnologiesId = table.Column<int>(type: "int", nullable: false),
                    PortfolioProjectsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DevelopmentTechnologyPortfolioProject", x => new { x.DevelopmentTechnologiesId, x.PortfolioProjectsId });
                    table.ForeignKey(
                        name: "FK_DevelopmentTechnologyPortfolioProject_DevelopmentTechnologies_DevelopmentTechnologiesId",
                        column: x => x.DevelopmentTechnologiesId,
                        principalTable: "DevelopmentTechnologies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DevelopmentTechnologyPortfolioProject_PortfolioProjects_PortfolioProjectsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DevelopmentTechnologyPortfolioProject_PortfolioProjectsId",
                table: "DevelopmentTechnologyPortfolioProject",
                column: "PortfolioProjectsId");

            migrationBuilder.CreateIndex(
                name: "IX_PortfolioClients_Name",
                table: "PortfolioClients",
                column: "Name");

            migrationBuilder.CreateIndex(
                name: "IX_PortfolioProjects_Name",
                table: "PortfolioProjects",
                column: "Name");

            migrationBuilder.CreateIndex(
                name: "IX_PortfolioProjects_PortfolioClientId",
                table: "PortfolioProjects",
                column: "PortfolioClientId");
