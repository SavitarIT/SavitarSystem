            ...
            new Client(clientId++, "Savitar IT Solutions")
            {
                Projects = new List<Project>
                {
                    new Project(projectId++, "# Savitar WebAssembly and Server : This website :)")
                    {
                        ...
                        DevelopmentTechnologies = new List<DevelopmentTechnology> { ProjectTechnologiesSeedData.VisualStudio, ProjectTechnologiesSeedData.DotNet5, ProjectTechnologiesSeedData.CSharp, ProjectTechnologiesSeedData.BlazorWebAssembly, ProjectTechnologiesSeedData.MudBlazor, ProjectTechnologiesSeedData.SQLServer, ProjectTechnologiesSeedData.WebAPI }
                    },
                    new Project(projectId++, "dBit : MWeb Payment Module")
                    {
                        ...
                        DevelopmentTechnologies = new List<DevelopmentTechnology> { ProjectTechnologiesSeedData.VisualStudio, ProjectTechnologiesSeedData.DotNetCore, ProjectTechnologiesSeedData.CSharp, ProjectTechnologiesSeedData.SQLServer }
                    },
...
I wrote the web application for the system that enabled users to setup the canisters, track their locations, monitor the status and reconcile cash-up once the canisters arrived at the cash centre.",
                        DevelopmentTechnologies = new List<DevelopmentTechnology> { ProjectTechnologiesSeedData.VisualStudio, ProjectTechnologiesSeedData.DotNetFramework, ProjectTechnologiesSeedData.CSharp, ProjectTechnologiesSeedData.SQLServer, ProjectTechnologiesSeedData.WebServices }
                    },
                    new Project(projectId++, "Adcheck Contractor")
                    {
                        ...
                        DevelopmentTechnologies = new List<DevelopmentTechnology> { ProjectTechnologiesSeedData.VisualStudio, ProjectTechnologiesSeedData.DotNetFramework, ProjectTechnologiesSeedData.CSharp, ProjectTechnologiesSeedData.SQLServer }
                    },
    ...
    <li>All images and data are stored in files encrypted using triple DES encryption. Data is overlaid on the images before storage as well as being stored alongside the images in the file for retrieval later.</li>
                        ...
                        DevelopmentTechnologies = new List<DevelopmentTechnology> { ProjectTechnologiesSeedData.VisualStudio, ProjectTechnologiesSeedData.DotNetFramework, ProjectTechnologiesSeedData.CSharp, ProjectTechnologiesSeedData.Delphi, ProjectTechnologiesSeedData.SQLServer }
                    },
    ...
    <li>Red robot violations cannot be handled by this system.</li>
                        ...
                        DevelopmentTechnologies = new List<DevelopmentTechnology> { ProjectTechnologiesSeedData.Delphi, ProjectTechnologiesSeedData.SQLServer }
                    },
...
Savitar IT was also responsible for the hosting and maintenance of this website for a few years.",
                        ...
                        DevelopmentTechnologies = new List<DevelopmentTechnology> { ProjectTechnologiesSeedData.VisualBasic, ProjectTechnologiesSeedData.DotNetFramework, ProjectTechnologiesSeedData.CSharp, ProjectTechnologiesSeedData.SQLServer, ProjectTechnologiesSeedData.Excel }
                    },
    ...
    <li>The web application owner would load the winning numbers after each draw. If any of the notifications in the system matched the winning numbers, an SMS would be sent to the end users via the ClickATell gateway notifying them of their winning numbers.</li>
                    ...
                    new Project(projectId++, "Dawn Wing")
                    {
                        ...
                        DevelopmentTechnologies = new List<DevelopmentTechnology> { ProjectTechnologiesSeedData.VisualStudio, ProjectTechnologiesSeedData.DotNetFramework, ProjectTechnologiesSeedData.CSharp, ProjectTechnologiesSeedData.VisualBasicNet }
                    },
...
<ul>
    ...
    <li>System had the ability to rate titles to facilitate lookups by tempo, genre, year, etc...</li>
                        ...
                        DevelopmentTechnologies = new List<DevelopmentTechnology> { ProjectTechnologiesSeedData.Delphi, ProjectTechnologiesSeedData.MSAccess }
                    },
...
<ul>
    ...
    <li>The system handles ordering, checkout and shipping tracking. Stock control is maintained on invoice and stock levels are automatically adjusted</li>
                    ...
                    new Project(projectId++, "Signal Systems")
                    {
                        ...
                        DevelopmentTechnologies = new List<DevelopmentTechnology> { ProjectTechnologiesSeedData.VisualStudio, ProjectTechnologiesSeedData.DotNetFramework, ProjectTechnologiesSeedData.CSharp }
                    },
    ...
    <li>A custom database backend was developed for use in this application employing the use of C++ structs. The custom database also supported indexing for fast retrieval.</li>
                        ...
                        DevelopmentTechnologies = new List<DevelopmentTechnology> { ProjectTechnologiesSeedData.CPP }
                    },
...
This was released free to the community and assisted me with further Winamp development.</li>
                        ...
                        DevelopmentTechnologies = new List<DevelopmentTechnology> { ProjectTechnologiesSeedData.Delphi }
                    },
...
Being the first PC developer in the company, I was also responsible for assisting with network installation, PC builds, etc...",
                        DevelopmentTechnologies = new List<DevelopmentTechnology> { ProjectTechnologiesSeedData.AS400, ProjectTechnologiesSeedData.Excel, ProjectTechnologiesSeedData.VisualBasic }
                    }
                }
            },
...
When this project started in 2005, my client only had installation files for the first version of their software. It was a Winforms application on the .NET 1 framework. I reverse engineered the system and extracted the required sources. The system was then upgraded to .NET Framework 2, and later to a web application. It then got a re-write about 6 years ago to the system it is currently.",
                        DevelopmentTechnologies        = new List<DevelopmentTechnology> { ProjectTechnologiesSeedData.VisualStudio, ProjectTechnologiesSeedData.DotNetFramework, ProjectTechnologiesSeedData.CSharp, ProjectTechnologiesSeedData.SQLServer, ProjectTechnologiesSeedData.Automapper, ProjectTechnologiesSeedData.StructureMap, ProjectTechnologiesSeedData.Postman }
                    },
                    new Project(projectId++)
                    {
                        Name = "Minegaze",
