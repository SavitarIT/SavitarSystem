...
namespace Savitar.Web.Services.Data
{
    public static class Technologies
    {
        ...
        public static readonly ProjectTechnology VBA = new ProjectTechnology("VBA", new DateTime(1996, 6, 1), TechnologyCategories.Language, new DateTime(1998, 1, 1), Frequencies.Rarely, Proficiencies.Intermediate);
